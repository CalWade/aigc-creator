...
{
  "logic": "and",
  "conditions": [["<source table field>", "<operator>", { "type": "constant", "value": "<val>" }]]
}
```
...
| `auto_number`                            | Not supported for constant comparison | Use dynamic field_ref instead                                                                      |
...
| `intersects` | Has intersection (non-empty overlap) | All types (most commonly used for dynamic field_ref) |
...
```json
{
  ...
  "where": {
    "logic": "and",
    "conditions": [["Exhibition", "intersects", { "type": "field_ref", "field": "ExhibitionName" }]]
  }
}
```
...
```json
{
  ...
  "where": {
    "logic": "and",
    "conditions": [["SupplierName", "intersects", { "type": "field_ref", "field": "Supplier" }]]
  }
}
```
...
```json
{
  ...
  "where": {
    "logic": "and",
    "conditions": [["ProjectName", "==", { "type": "field_ref", "field": "ProjectName" }]]
  }
}
```
