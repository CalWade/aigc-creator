...
| [`+messages-mget`](references/lark-im-messages-mget.md)                             | Batch get messages by IDs; user/bot; fetches up to 50 om\_ message IDs, formats sender names, expands thread replies                                                                                                                                                   |
...
| [`+threads-messages-list`](references/lark-im-threads-messages-list.md)             | List messages in a thread; user/bot; accepts om*/omt* input, resolves message IDs to thread_id, supports sort/pagination                                                                                                                                               |
